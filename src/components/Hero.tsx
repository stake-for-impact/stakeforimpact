                        ...
                        <div className="text-center">
                            ...
                            <div className="flex justify-center w-full max-w-2xl gap-2 mx-auto mt-6">
                                ...
                                <div className="mt-3 rounded-lg sm:mt-0 sm:ml-3">
                                    <button className="items-center block px-5 lg:px-10 py-3.5 text-base font-medium text-center text-blue-600 transition duration-500 ease-in-out transform border-2 border-white shadow-md rounded-xl focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500">List of projects</button>
                                </div>
                            </div>
                        </div>
                    </div>
